...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-white text-gray-800">
      <header className="bg-gradient-to-br from-[#1a3a52] to-[#2a4a62] text-white py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <Link href="/">
            <Logo variant="white" className="cursor-pointer" />
          </Link>
          <Link href="/" className="text-white/80 hover:text-[#d4af37] transition-colors text-sm">
            ← Back to Home
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-10 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#1a3a52] mb-3">2. Who We Are</h2>
            <p>
              TrueClaim & Associates Ltd. is a fraud investigation and asset recovery firm registered in Canada, operating under Business Number (BN): 842594962, Registry ID: 2112580. Our registered office is located in <strong>Cambridge, Ontario, Canada</strong>.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#1a3a52] mb-3">3. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#1a3a52] mb-3">4. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#1a3a52] mb-3">5. Disclosure of Your Information</h2>
      ...
      <footer className="bg-[#1a3a52] text-white/70 text-center py-6 text-sm mt-10">
        <p>&copy; 2013 TrueClaim & Associates Ltd. All rights reserved. | Cambridge, Ontario, Canada</p>
      </footer>
    </div>
  );
}
