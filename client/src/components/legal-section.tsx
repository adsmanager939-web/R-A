        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>Refund & Associates provides fraud investigation and recovery services. Results cannot be guaranteed and depend on various factors including the nature of the fraud, available evidence, and cooperation of financial institutions.</p>
          ...
          <div id="privacy">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>Your privacy is paramount to our mission. All personal information shared with Refund & Associates is protected under attorney-client privilege and industry-standard encryption.</p>
              ...
              <p><strong>Contact:</strong> Questions about our privacy practices can be directed to privacy@refund-associates.com</p>
            </div>
          </div>
        </div>
      </div>
