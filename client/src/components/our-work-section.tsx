      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase leading-none tracking-tight mb-8">
            ...
            <div className="flex items-end gap-4 mb-8">
              ...
              <div className="pb-3">
                ...
                <div className="text-white/40 text-sm">In Recovery</div>
              </div>
            </div>
